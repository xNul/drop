...
function love.draw()
	...
	elseif not music_exists then
		...
		if appdata_music then
			...
			love.graphics.printf("There aren't any songs in \""..appdata_path.."/LOVE/Drop/music\" yet.  If you put copy some there, this feature will work.", 1, graphics_height/2, graphics_width, "center")
		end
	end
